##  Copyright (c) 2011 Davide Ficano. All rights reserved.
...
set visdiff_path to "/Applications/VisualDiffer.app/Contents/Resources/visdiff"
...
on removeFile(path)
	tell application "Finder"
		if exists path as POSIX file then
